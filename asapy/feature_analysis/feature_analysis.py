...
class FeatureAnalysis(object):
    ...
    def get_box_violin_plots(self):
        ...
        for feat_name in sorted(self.scenario.features):
            ...
            axes[0].violinplot([vec],showmeans=False,showmedians=True, vert=False)
            ...
            out_fn = "violin_box_%s_plot.png" %(feat_name.replace("/" ,"_"))
            plt.savefig(out_fn)
    ...
    def correlation_plot(self):
        ...
        out_plot = os.path.join(self.output_dn, "correlation_plot_features.png")
    ...
    def feature_importance(self):
        ...
        self.scenario.feature_data = self.scenario.feature_data.fillna(self.scenario.feature_data.mean()) 
        ...
        # sort features by average importance and look only at the first 15 features
    ...
    def cluster_instances(self):
        ...
        # impute missing data; probably already done, but to be on the safe side
        self.scenario.feature_data = self.scenario.feature_data.fillna(self.scenario.feature_data.mean())
